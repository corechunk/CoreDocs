...
20. [20-command-substitution.md](./20-command-substitution.md) **[PRO]** (popen() capturing)
21. [21-type-casting.md](./21-type-casting.md) **[CORE]** (Implicit vs. Explicit)

### Phase 6: Control Flow
22. [22-truth-rule.md](./22-truth-rule.md) **[CORE]** (Truthiness/Zero-parity)
...
27. [27-function-basics.md](./27-function-basics.md) **[CORE]** (Declaration, Blocks)
28. [28-return-types.md](./28-return-types.md) **[CORE]** (Void, early returns)
29. [29-recursion.md](./29-recursion.md) **[CORE]** (Call Stack visuals)
30. [30-passing-mechanisms.md](./30-passing-mechanisms.md) **[CORE]** (Value vs Pointer)
...
35. [35-procedural-mechanisms.md](./procedural/35-procedural-mechanisms.md) **[PRO]**
    - Manual Methods (passing `this` pointer).
    - Composition (Nesting structs).
    - Memory Alignment & Opaque Pointers.

### Phase 9: Object-Oriented Programming
36. [36-class-concept.md](./36-class-concept.md) **[CORE]** (Base form: State + Methods)
37. [37-advanced-oop.md](./oop/37-advanced-oop.md) **[PRO]**
    - C-Style Encapsulation, VTables, Polymorphism.
...
39. [39-multi-threading.md](./concurrency/39-multi-threading.md) **[SYSTEMS]** (pthreads, concurrency)
40. [40-async-coroutines.md](./concurrency/40-async-coroutines.md) **[PRO]** (Non-blocking select/poll)
41. [41-synchronization-locks.md](./concurrency/41-synchronization-locks.md) **[SYSTEMS]** (Mutex, Semaphores)
...
43. [43-tcp-udp-patterns.md](./network/43-tcp-udp-patterns.md) **[SYSTEMS]** (Streams vs. Datagrams)
44. [44-http-client-api.md](./network/44-http-client-api.md) **[PRO]** (libcurl/sockets)

### Phase 12: OS Bridge & Memory
45. [45-io-streams.md](./45-io-streams.md) **[CORE]** (stdin, stdout, stderr)
46. [46-redirection-piping.md](./46-redirection-piping.md) **[PRO]** (dup2, pipe)
47. [47-exit-codes-signals.md](./47-exit-codes-signals.md) **[SYSTEMS]** (Process termination, SIGINT)
...
49. [49-error-handling.md](./49-error-handling.md) **[CORE]** (errno, setjmp/longjmp)

### Phase 13: Project Lifecycle & Build
50. [50-multi-file-projects.md](./build/50-multi-file-projects.md) **[PRO]** (Headers vs. Source)
51. [51-build-tools.md](./build/51-build-tools.md) **[PRO]** (Make/CMake)
52. [52-linking-delivery.md](./build/52-linking-delivery.md) **[SYSTEMS]** (Static vs Dynamic)
53. [53-standard-library.md](./53-standard-library.md) **[PRO]** (libc utility list)
